...
namespace ASPMVCWebAppAssign1.Models
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        [DbFunction("NorthwindEntities", "GetAllCustomerByCountry")]
        public virtual IQueryable<GetAllCustomerByCountry_Result> GetAllCustomerByCountry(string country)
        {
            var countryParameter = country != null ?
                new ObjectParameter("country", country) :
                new ObjectParameter("country", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<GetAllCustomerByCountry_Result>("[NorthwindEntities].[GetAllCustomerByCountry](@country)", countryParameter);
        }
